...
/**
 * Calculated parameters for the creation of a new Casting Check, based off an
 * Actor's data.
 ...
 *    extra success.
 * @property {boolean} reflexesCheck - Whether the effects can be resisted with a
 *    Reflexes check.
 * @property {boolean} resilienceCheck - Whether the effects can be resisted with
 *    a Resilience check.
 * @property {boolean} willpowerCheck - Whether the effects can be resisted with a
 *    Willpower check.
 ...
 *    applied.
 * @property {number} healing - The minimum Healing to apply on a successful
 *    check.
 ...
 *    applied.
 * @property {ScalingAspectBase[]} scalingAspect - Array of scaling spell
 *    aspects.
 ...
 * @param {CastingCheckOptions} options - Fully populated Casting Check
 *    Options.
