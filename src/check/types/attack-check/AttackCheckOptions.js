 ...
 * @property {boolean} [ineffective] Whether this Attack is an Ineffective
 *    attack.
 ...
 * @property {boolean} [penetrating] Whether this Attack is a Penetrating
 *    attack.
 * @property {boolean} [plusExtraSuccessDamage] Whether to increase the damage
 *    for each extra success.
 * @property {boolean} [rend] Whether this check is a Rend attack.
 * @property {number} [attackIdx] The index of the weapon's Attack being
 *    rolled.
 ...
 * @property {string} [type] The Type of Attack being performed (Melee or
 *    Ranged).
 */
