/**
 * Calculated parameters for the creation of a new Attack Check, based off an
 * Actor's data.
 ...
 * @property {boolean} plusExtraSuccessDamage Whether to increase the damage for
 *    each extra success.
 ...
 *    applied.
 * @property {string[]} attackTrait Array of standard attack traits applied to
 *    this attack.
