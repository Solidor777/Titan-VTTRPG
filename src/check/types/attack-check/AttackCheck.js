...
export default class AttackCheck extends TitanCheck {
    ...
    * Makes a call to the parent function, but has some additional functionality
    * for spending expertise to
    * maximize the benefits of attack traits.
    * @param {number[]} sortedDice - Results of the dice roll, sorted from
    *    largest to smallest.
   ...
   _applyExpertise(sortedDice) {
      ...
      // If we have expertise remaining, and this attack would benefit from
      // critical successes
