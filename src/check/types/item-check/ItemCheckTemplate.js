 ...
 * @property {boolean} enabled - Whether the opposed check is enabled for the
 *    owning check.
 ...
 * @property {OpposedCheckBase} opposedCheck - The check that can be used to
 *    oppose this check, if any.
 * @property {boolean} isDamage - Whether the check inflicts damage.
 * @property {boolean} isHealing - Whether the check heals damage.
 * @property {boolean} scaling - Whether subsequent successes should scale the
 *    initial value.
 ...
 *    Success.
 * @property {number} initialValue - The initial value of the Healing or Damage,
 *    if applicable.
 * @property {number} resolveCost - The resolve cost for performing the check, if
 *    any.
 * @property {string} attribute - The Attribute to use for the Check.
 * @property {string} damageReducedBy - What opposed check that can reduce this
 *    damage, if any.
 * @property {string} label - The display name of the check.
 * @property {string} resistanceCheck - The Resistance that can be used to oppose
 *    this check.
 * @property {string} skill - The Skill to use for the Check.
 ...
 * @returns {ItemCheckTemplate} The new Item Check Template with the default
 *    options.
 */
