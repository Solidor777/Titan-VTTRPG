...
import { splitFolderPath, unescapeFolderName } from '~/spreadsheet/io/FolderPath.js';
...
export function workbookToDocuments(workbook) {
   ...
   return envelopes
      ...
      .map((envelope) => ({
         ...
         folderPath: envelope.folderPath ? splitFolderPath(envelope.folderPath).map(unescapeFolderName) : [],
