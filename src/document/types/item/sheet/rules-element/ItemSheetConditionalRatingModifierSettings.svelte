<script>
   ...
   import DocumentArmorTraitSelect from '~/document/sheet/select/DocumentArmorTraitSelect.svelte';
   import DocumentShieldTraitSelect from '~/document/sheet/select/DocumentShieldTraitSelect.svelte';
