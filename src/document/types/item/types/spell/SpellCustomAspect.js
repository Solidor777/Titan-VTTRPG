 ...
 * @property {boolean} scaling Whether the effect of the Aspect increases with
 *    extra successes.
 * @property {number} initialValue The initial value of the Aspect's effects
 *    when successfully cast.
 * @property {number} cost The Aspect Cost for determine Difficulty and
 *    Complexity.
 * @property {string} resistanceCheck A Resistance that can be used to resist
 *    the effects of the aspect.
 ...
 * @returns {SpellCustomAspect} The Custom Aspect with the default options set.
 */
