/**
 * @typedef {object} CharacterSheetData Data representing the state of a Character Sheet.
 ...
 * @property {string} tabs.skills.filter - The current filter text for the Skills tab.
