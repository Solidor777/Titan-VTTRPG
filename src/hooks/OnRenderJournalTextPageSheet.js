...
/**
 * Called before a Journal Text Page Sheet is rendered to add the dark mode
 * class if appropriate.
 * @param {JournalSheet} journalSheet - The Journal Text Page Sheet being
 *    rendered.
 * @param {Element} element - The Element of the Journal Text Page Sheet being
 *    rendered.
 */
