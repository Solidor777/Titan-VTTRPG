...
/**
 * Gets the best Player user who owns the document, prioritizing active players.
 * @param {Document} document - The document to find the best player owner for.
 * @returns {User | boolean} The first, best, non-gm user who owns the document, or false if there are none.
 */
      ...
      if (playerOwners.length > 1) {
         ...
         if (activeOwners.length > 0) {
            ...
            if (activeOwners.length > 1) {
               ...
               // Check if one of the players has this document set to their.
               // character.
