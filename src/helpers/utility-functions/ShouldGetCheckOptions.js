...
/**
 * Determines whether we should open a dialog for setting check options before rolling a check. This is normally
 * dependent on the system setting, but is inverted if the modifier key is pressed.
