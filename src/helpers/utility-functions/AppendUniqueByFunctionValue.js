/**
 * Adds each entry from the source array to the destination array, provided that said entry is not already in the
 * destination array. Uses a function to determine whether the object is already in the array.
