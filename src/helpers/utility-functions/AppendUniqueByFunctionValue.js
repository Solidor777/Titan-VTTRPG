 ...
 * @param {object[]} destination - The Document this sheet is for.estination
 *    array.
 * @param {object[]} source - The source array.
 * @param {Function} idFunction - The function to be applied to object from the
 *    source array to determine whether it is
 * already in the destination array. If another object in the destination array
 * already
