...
/**
 * Generates a tooltip for a stat with a breakdown of any bonuses or penalties
 * from item or effect modifiers.
 * @param {number} baseValue - The base value of the stat before any modifiers
 *    are applied.
 * @param {number} value - The value of the stat after any modifiers are
 *    applied.
 ...
 * @param {number} extraMod - Sum bonuses and penalties from additional
 *    modifiers.
 * @param {string} [baseTooltip] - Label for the base value of the stat in the
 *    tooltip.
 * @returns {string} Tooltip for the stat with a breakdown of any bonuses or
 *    penalties from item or effect modifiers.
 */
