...
/**
 * Called when the user chooses to regenerate a random UUID for an actor or
 * item.
 ...
 * If the Confirm Regenerate UUID is true in the game settings, will bring up a
 * dialog to confirm regeneration.
 * @param {TitanActor|TitanItem} document - The Actor or Item to generate a new
 *    UUID for.
 * @returns {Application|void} The rendered dialog instance, if a valid document
 *    was provided.
 */
