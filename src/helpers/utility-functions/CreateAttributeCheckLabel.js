...
/**
 * Helper function for creating a formatted and localized DC Label for the
 * provided Attribute Check.
 * @param {string} attribute - The Attribute to use for the Check.
 * @param {string} [skill] - The Skill to use for the Check.
 * @param {number} [difficulty] - The minimum roll on a die to achieve a
 *    Success, if any.
 * @param {number} [complexity] - The minimum number of Successes needed to
 *    succeed at the Check, if any.
