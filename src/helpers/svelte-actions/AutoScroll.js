/**
 * Action for auto-scrolling to the bottom of the chat log when displaying a chat message with Svelte components.
 * @param {Element} element - The Element containing the Svelte components.
 */
