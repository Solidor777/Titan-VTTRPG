 ...
 * Object containing the information for a stat that can be modified by items or
 * effects.
 * @property {number} baseValue The base value of the stat before any modifiers
 *    are applied.
 * @property {number} value The value of the stat after any modifiers are
 *    applied.
